...
1. **[README.md](./README.md)** - 设计系统总览（本文档）
   - 设计理念和视觉系统
   - 色彩、字体、间距规范
   - 动效和交互原则

2. **[design-tokens.css](./design-tokens.css)** - CSS 设计变量
   - 可直接使用的 CSS 变量
   - 支持亮色/暗色主题
   - 全局基础样式

3. **[components.md](./components.md)** - 组件库文档
   - 按钮、卡片、表单等基础组件
   - 完整的 HTML/CSS 实现
   - 响应式适配方案

4. **[layouts.md](./layouts.md)** - 页面布局规范
   - 书架、书籍详情、上传、设置页面
   - 响应式布局策略
   - 导航系统设计
...
5. **[landing-page.md](./landing-page.md)** - 网站主页设计
   - 英雄区、功能展示、工作流程
   - CTA 转化设计
   - 性能优化建议

6. **[auth-pages.md](./auth-pages.md)** - 登录注册页面
   - 邮箱 + 验证码认证流程
   - 表单验证和交互逻辑
   - 安全性考虑
